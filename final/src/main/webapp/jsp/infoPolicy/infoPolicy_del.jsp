		...
		<div id="infoPolicydel_wrap">
			<form method="post" action="infoPolicy_del_ok.nhn" onsubmit="return del_check()">
				...
				<div id="infoPolicydel_menu" style="text-align:center; padding-top: 5%;" style="width:40%">
					...
					<input type="reset" value="취소" style="background-color:#ffffff; color:#828282;border:none; border-radius:3px; width:10%; height:10%; border:1.5px solid #008CBA; " onclick="location='infoPolicy_list.nhn?page=1'" />
				</div>
			</form>
		</div>
	</div>
